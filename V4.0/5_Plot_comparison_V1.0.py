...
if __name__=="__main__":
    ...
    ############### NEW
    parser.add_argument("--seq_labels","-sl",help="Labels for the sequence annotation. Meust correspond to name given in other programs. Default is \"all\", which is the whole sequence. Can be multiple arguments.")
    ...
    OU.get_gene_annotation_label_dic()
